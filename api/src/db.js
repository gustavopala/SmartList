...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/smartlist`, {
...
const { Recipe, Ingredient, Recipe_ingredient, User, UserSelection , ShoppingList, ShoppingListItem} = sequelize.models;

Recipe.belongsToMany(Ingredient, { through: Recipe_ingredient, foreignKey: 'recipe_id' });
Ingredient.belongsToMany(Recipe, { through: Recipe_ingredient, foreignKey: 'ingredient_id' });
...
// Relación para ShoppingList y User
